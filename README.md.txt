...
- Определить объекты, в которых будут храниться данные.  
- Определить связи между объектами для хранения данных.  
- Нарисовать схему объектной модели (любые обозначения).  
